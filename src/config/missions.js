	...
	"mission-3-first-watch": {
		...
		adventures: {
			lake_norman_guardians: {
				...
				/**
				 * Location-only rewards for the interactive decoder. The server
				 * selects from entries the shared index has not found and never
				 * exposes the target's code, record, or private steering.
				 */
				clueHints: {
					"F-01": "THE LOWER KITCHEN. FIND THE OVEN THAT HAS NOT BEEN USED IN WEEKS.",
					"F-02": "THE RED BEDROOM BATHROOM. LOOK UNDER THE BASIN WHERE THE PIPES RUN.",
					"F-03": "MIMI'S ROOM. SEARCH THE DESK.",
					"F-04": "THE OFFICE DESK. LIFT THE KEYBOARD AND CHECK THE NARROW GAP BENEATH IT.",
					"F-05": "FIND SOMETHING MADE TO KEEP A PERSON ABOVE WATER. LOOK INSIDE A LIFE JACKET.",
					"F-06": "FIND THE DRAWER THAT ISN'T FOR ANYTHING. LIFT THE DIVIDED TRAY INSIDE IT.",
					"F-07": "NELSON AND LAURA'S HOUSE. SEARCH THE SIDE THAT FACES THE WATER.",
					"F-08": "JANE AND DONNY'S HOUSE. SEARCH THE BACK PORCH ON THE WATER SIDE.",
					"F-09": "TAYLOR AND ANDREW'S HOUSE. SEARCH THE BACK PORCH ON THE WATER SIDE.",
					"F-10": "YOUR OWN BACK PORCH. LOOK WHERE EVERYONE WALKS WITHOUT LOOKING DOWN.",
					"F-11": "IN THE MAIN ROOM, REACH BEHIND THE LARGEST SCREEN.",
					"F-12": "FIND THE OTHER TELEVISION. SEARCH BEHIND IT TOO.",
					"F-13": "OUTSIDE, FIND THE SMALL BUILDING MADE ONLY FOR CHILDREN.",
					"F-14": "CHECK THE GLOVEBOX OF THE SMALL VEHICLE THAT ISN'T A CAR.",
					"F-15": "IN THE DINING ROOM, LOOK ON TOP OF A CHAIR — NOT UNDERNEATH.",
					"F-16": "OPEN THE COLD BOX NEAR THE POOL.",
					"F-17": "WALK THE WATERLINE SLOWLY. THE LAKE MAY HAVE MOVED THIS ONE.",
					"F-18": "IN THE GARAGE, SEARCH THE WORKSHOP SIDE WHERE THINGS ARE BUILT.",
					"F-19": "DOWNSTAIRS, SEARCH A SHELF IN THE PANTRY CLOSET.",
					"F-20": "IN THE CABANA BY THE WATER, OPEN A CABINET.",
					"F-21": "CHECK THE REFRIGERATOR IN THE PANTRY OFF THE KITCHEN.",
					"F-22": "SEARCH THE FRONT PORCH, ON THE SIDE WHERE VISITORS ARRIVE.",
					"F-23": "SEARCH ABOARD THE FLAT, SLOW PONTOON BOAT.",
					"F-24": "AT TAYLOR AND ANDREW'S HOUSE, LOOK UNDER A SOFA CUSHION.",
					"F-25": "SEARCH ABOARD THE RED BOAT — NOT THE OTHER ONE.",
					"F-26": "UPSTAIRS, OPEN A DRAWER IN THE GUEST BATHROOM NOBODY USES.",
					"F-27": "FIND THE DISUSED CONTROL BOX FOR THE OLD RED-BOAT LIFT.",
					"F-28": {
						text: "GREEN FROGS. THE FROZEN YOGURT SHOP. ATHENA WILL EXPLAIN WHEN YOU ARRIVE.",
						requiresConvergence: "FINALE_UNLOCK",
					},
				},
